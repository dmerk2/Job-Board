...
const userJobMapping = [
  { userId: users[3]._id, jobIds: [jobs[0]._id, jobs[1]._id] },
  { userId: users[4]._id, jobIds: [jobs[2]._id, jobs[3]._id] },
  { userId: users[5]._id, jobIds: [jobs[4]._id, jobs[5]._id] },
];
