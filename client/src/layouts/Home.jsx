...
function Home() {
  ...
  {/* First Row: Image on the right, Title and Text on the left*/}
  ...
  <div className="w-full md:w-1/2 md:pr-8 lg:hidden sm:block pb-6">
    ...
    <div className="my-auto w-full md:w-1/2 md:pl-8">
      ...
      <p className=" text-justify text-gray-600 mb-8 w-3/4 mx-auto">
        Embark on an exhilarating journey with Hop on Board as you navigate
        through a sea of boundless career opportunities. Our intuitive job
        search feature empowers you to explore and uncover the perfect role
        tailored to your unique preferences and unparalleled skills. Dive deep
        into a world of endless possibilities, where every click brings you
        closer to your dream job. With Hop on Board by your side, the adventure
        of a lifetime awaits as you embark on a quest to find the career path
        that ignites your passion and fulfills your ambitions.
      </p>
    </div>
  ...
  {/* Second Row: Image on the left, Title and Text on the right */}
  <div className="flex flex-col md:flex-row justify-center items-center md:items-start md:justify-between">
    <div className="w-full md:w-1/2 md:pr-8 sm:pb-6 xs:pb-6 2xs:pb-6">
      <img src={Resume} alt="Portfolio Building" className="w-1/2 mx-auto" />
    </div>
    <div className="w-full my-auto md:w-1/2 md:pl-8">
      ...
      <p className=" text-justify text-gray-600 mb-8 w-3/4 mx-auto">
        ...
        customizable profile showcase. Unleash your full potential by crafting
        a captivating profile adorned with your striking portrait, a captivating
        bio that narrates your career journey, and a meticulously curated list of
        your unparalleled skills. Impress potential employers with a glimpse
        into your unique personality and expertise, all beautifully showcased
        in one mesmerizing digital space. It is not just a profile page, it is
        your spotlight on the grand stage of career opportunities.
      </p>
    </div>
  </div>
</section>
      ...
      <section className="bg-gray-100">
        <h2 className="text-3xl text-center font-bold mb-4 py-auto">Jobs</h2>
